...
export const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'cursos', label: 'Mis Cursos', icon: 'fa-graduation-cap' },
  { key: 'entrenamiento', label: 'Entrenamiento', icon: 'fa-dumbbell' },
...
export const VIEW_TITLES: Record<string, [string, string, string]> = {
  ...
  cursos: ['Mis Cursos', 'fa-graduation-cap', 'Inicio / Mis Cursos'],
  entrenamiento: ['Entrenamiento', 'fa-dumbbell', 'Inicio / Entrenamiento'],
